# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/timers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/timers.c" 2
...
# 2 "../../Internship Project/Emertxe project/Washing_Machine.X/timers.c" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/timers.h" 1



void init_timer2(void);
# 3 "../../Internship Project/Emertxe project/Washing_Machine.X/timers.c" 2
