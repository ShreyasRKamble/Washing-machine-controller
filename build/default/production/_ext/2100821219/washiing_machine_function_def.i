# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/washiing_machine_function_def.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/washiing_machine_function_def.c" 2

# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/main.h" 1
# 11 "../../Internship Project/Emertxe project/Washing_Machine.X/main.h"
...
# 12 "../../Internship Project/Emertxe project/Washing_Machine.X/main.h" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/clcd.h" 1
# 36 "../../Internship Project/Emertxe project/Washing_Machine.X/clcd.h"
void init_clcd(void);
void clcd_putch(const char data, unsigned char addr);
void clcd_print(const char *str, unsigned char addr);
void clcd_write(unsigned char byte, unsigned char mode);
# 13 "../../Internship Project/Emertxe project/Washing_Machine.X/main.h" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/digital_keypad.h" 1
# 31 "../../Internship Project/Emertxe project/Washing_Machine.X/digital_keypad.h"
unsigned char read_digital_keypad(unsigned char mode);
void init_digital_keypad(void);
# 14 "../../Internship Project/Emertxe project/Washing_Machine.X/main.h" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/timers.h" 1



void init_timer2(void);
# 15 "../../Internship Project/Emertxe project/Washing_Machine.X/main.h" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/washing_machine_header.h" 1
# 11 "../../Internship Project/Emertxe project/Washing_Machine.X/washing_machine_header.h"
...
# 16 "../../Internship Project/Emertxe project/Washing_Machine.X/main.h" 2
# 3 "../../Internship Project/Emertxe project/Washing_Machine.X/washiing_machine_function_def.c" 2
...
void washing_program_display(unsigned char key) {
    ...
    clcd_putch('*', (0xC0 + 0));
    if (program_no <= 9) {
        clcd_print(washing_program[program_no], (0xC0 + 1));
        clcd_print(washing_program[program_no + 1], (0x90 + 1));
        clcd_print(washing_program[program_no + 2], (0xD0 + 1));
    } else if (program_no == 10) {
        clcd_print(washing_program[program_no], (0xC0 + 1));
        clcd_print(washing_program[program_no + 1], (0x90 + 1));
        clcd_print(washing_program[0], (0xD0 + 1));
    } else if (program_no == 11) {
        clcd_print(washing_program[program_no], (0xC0 + 1));
        clcd_print(washing_program[0], (0x90 + 1));
        clcd_print(washing_program[1], (0xD0 + 1));
    }
...
void water_level_screen(unsigned char key) {
    ...
    clcd_print("WATER_LEVEL:", (0x80 + 0));
    clcd_putch('*', (0xC0 + 0));
    clcd_print(water_level[level], (0xC0 + 2));
    clcd_print(water_level[(level + 1) % 5], (0x90 + 2));
    clcd_print(water_level[(level + 2) % 5], (0xD0 + 2));
...
void run_program(unsigned char key) {
    ...
    if (reset_flag == 0x33) {
        clear_screen();
        clcd_print("Prog:", (0x80 + 0));
        clcd_print(washing_program[program_no], (0x80 + 6));
        ...
        _delay((unsigned long)((2000)*(20000000/4000.0)));
        clear_screen();
        clcd_print("Function:", (0x80 + 0));
        clcd_print("TIME", (0xC0 + 0));
        clcd_print("5:START 6:PAUSE", (0x90 + 0));
    ...
    if (min == 0 && sec == 0) {
        ...
        RC2 = 0;
        RC1 = 1;
        clcd_print("Program completed", (0x80 + 0));
        clcd_print("Remove clothes", (0xC0 + 0));
        _delay((unsigned long)((2000)*(20000000/4000.0)));
        RC1 = 0;
        operational_mode = 0x01;
        reset_flag = 0x11;
        clear_screen();
    }
   ...
   if (RB0 == 0)
{
    ...
    RC1 = 1;
    clear_screen();
    clcd_print("Door is open", (0x80 + 0));
    clcd_print("Please close door", (0xC0 + 0));
