# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/main.c" 2
...
# 10 "../../Internship Project/Emertxe project/Washing_Machine.X/main.c" 2
...
void main(void) {
    ...
    while (1) {
        ...
        if ((key == 0x99) &&(operational_mode == 0x01)) {
            operational_mode = 0x02;
            reset_flag = 0x22;
            _delay((unsigned long)((200)*(20000000/4000.0)));
        } else if ((key == 0x99) &&(operational_mode == 0x02)) {
            operational_mode = 0x03;
            clear_screen();
        ...
        else if(key == 0x2F && operational_mode ==0x44){
