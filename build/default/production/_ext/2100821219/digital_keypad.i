# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/digital_keypad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../Internship Project/Emertxe project/Washing_Machine.X/digital_keypad.c" 2
...
# 2 "../../Internship Project/Emertxe project/Washing_Machine.X/digital_keypad.c" 2
...
# 3 "../../Internship Project/Emertxe project/Washing_Machine.X/digital_keypad.c" 2
...
unsigned char read_digital_keypad(unsigned char mode) {
    ...
    if (key != 0x3F && once) {
        ...
        longpressed++;
    } else if (!once && longpressed == 31 && key == 0x37) {
        longpressed++;
        return 0x99;
    }
    return 0x3F;
